...
func Translation(lang, content string) (aimContent, srcLang string) {
	...
	collector.UserAgent = getUA()
	aimURL, err := createURL(lang, content)
	if err != nil {
		log.Println("err:", err)
	}
	...
	return aimContent, srcLang
}

func createURL(lang, content string) (string, error) {
	var (
		tk  string
		err error
	)
	if tk, err = getTK(content); err != nil {
		return "", err
	}
	return "https://translate.google.cn/translate_a/single" +
		"?client=webapp&sl=auto" +
		"&tl=" + lang +
		"&hl=en" +
		"&dt=at&dt=bd&dt=ex&dt=ld&dt=md&dt=qca&dt=rw&dt=rm&dt=ss&dt=t" +
		"&source=bh&ssel=0&tsel=0" +
		"&kc=0&tk=" + tk +
		"&q=" + url.QueryEscape(content), nil

}

func getTK(content string) (tk string, errMsg error) {
	var (
		vm  *otto.Otto
		va  otto.Value
		err error
	...
	vm = otto.New()
	if err = vm.Set("a", content); err != nil {
		log.Println(err)
		return
	}
	if _, err = vm.Run(`
	    ...
	    function TL(a) {
	        ...
	        for (var e = [], f = 0, g = 0; g < a.length; g++) {
				...
				g + 1 < a.length && 56320 == (a.charCodeAt(g + 1) & 64512) ? (m = 65536 + ((m & 1023) << 10) + (a.charCodeAt(++g) & 1023),
	                e[f++] = m >> 18 | 240,
	...
	if va, err = vm.Run("VL(a)"); err != nil {
		log.Fatal(err)
		return
	}
	// va is an int64 with a value of 16
	if tk, err = va.ToString(); err != nil {
		log.Fatal(err)
		return
	}
	return
...
func getResult(byte []byte) (aimContent, srcLang string) {
	body := string(byte)
	result := gjson.Parse(body)               //解析谷歌翻译响应内容
	aimContent = result.Get("0.0.0").String() //提取文本翻译结果
	srcLang = result.Array()[2].String()      //提取源语言
	return
...
func getUA() string {
	userAgent := []string{
		...
		"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; WOW64; Trident/5.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; " +
			"Zune 4.0; InfoPath.3; MS-RTC LM 8; .NET4.0C; .NET4.0E)",
		"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; WOW64; Trident/5.0; .NET CLR 3.5.30729; .NET CLR 3.0.30729; .NET CLR 2.0.50727; Media Center PC 6.0)",
		"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Win64; x64; Trident/5.0; .NET CLR 3.5.30729; .NET CLR 3.0.30729; .NET CLR 2.0.50727; Media Center PC 6.0)",
		"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Win64; x64; Trident/5.0; .NET CLR 2.0.50727; SLCC2; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; " +
			"Zune 4.0; Tablet PC 2.0; InfoPath.3; .NET4.0C; .NET4.0E)",
		...
		"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.1; Trident/5.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; " +
			"Media Center PC 6.0; FDM; .NET CLR 1.1.4322; .NET4.0C; .NET4.0E; Tablet PC 2.0)",
		...
		"Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; MS-RTC LM 8; " +
			".NET4.0C; .NET4.0E; Zune 4.7; InfoPath.3)",
		"Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; MS-RTC LM 8; " +
		...
		"Mozilla/5.0 (X11; U; Linux x86_64; en-US; rv:1.9.1.15) Gecko/20101027 Mozilla/5.0 (Windows; U; Windows NT 5.2; en-US) " +
		...
		"Mozilla/5.0 (Macintosh; U; PPC Mac OS X 10.5; en-US; rv:1.9.1b3pre) Gecko/20081212 Mozilla/5.0 (Windows; U; Windows NT 5.1; en) " +
		...
		"Mozilla/5.0(iPad; U; CPU iPhone OS 3_2 like Mac OS X; en-us) AppleWebKit/531.21.10 (KHTML, like Gecko) " +
			"Version/4.0.4 Mobile/7B314 Safari/531.21.10gin_lib.cc",
		...
		"Mozilla/5.0 (iPhone Simulator; U; CPU iPhone OS 3_2 like Mac OS X; en-us) AppleWebKit/531.21.10 (KHTML, like Gecko) " +
			"Version/4.0.4 Mobile/7D11 Safari/531.21.10",
		...
		"Mozilla/5.0 (iPad; U; CPU OS 3_2 like Mac OS X; en-us) AppleWebKit/531.21.10 (KHTML, like Gecko) " +
			"Version/4.0.4 Mobile/7B334b Safari/531.21.1021.10gin_lib.cc",
	...
	return userAgent[rand.Intn(896)]
}
